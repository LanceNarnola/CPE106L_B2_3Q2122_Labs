...
"""
    ...
    5. A diamond cannot be placed diagonally, so if a shot hits the rest of
        the diamond is in one of 4 directions, left, right, up, and down
    6. If all diamonds are unearthed before using up all bullets, you win
        else, you lose
    Legend:
...
def main():
    ...
    print("-----Welcome to Diamonds & Seekers-----")
